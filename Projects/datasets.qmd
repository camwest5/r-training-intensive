...
| [Melbourne housing data](../data_sources/melb_data.csv) | A collection of houses for sale in Melbourne. [See here for variable explanations](https://www.kaggle.com/datasets/dansbecker/melbourne-housing-snapshot) | 
| [Goodreads books](../data_sources/books.csv) | Data from Goodreads books |
| [Queensland hospitals](../data_sources/hospital_data.csv) | Emergency department statistics. [See here for source and details](https://www.data.qld.gov.au/dataset/emergency-departments-quarterly-data). |
